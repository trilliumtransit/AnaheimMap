...
// add modifications to add the transit & trails API key


$url = $_GET['url'];
if (isset($_GET['trails_api'])) {$url = $url.'&key=4dbe8e62159ffdff3945611f4ed58ba93c361776276464d876106d66b8c42d88';}
